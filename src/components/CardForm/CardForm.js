        ...
        <div className='centered-overlay'>
                <div className='centered-content'>
                        ...
                        <div className='form'>
                                ...
                                <input name='nameSize' value={data.nameSize ?? ''} onChange={changeHadler}/>
                                ...
                                <input name='textSize' value={data.textSize ?? ''} onChange={changeHadler}/>
                                ...
                                <input name='textDownSize' value={data.textDownSize ?? ''} onChange={changeHadler}/>
